        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-blue-600 text-white rounded-xl flex items-center justify-center font-bold text-lg">E</div>
                    <span class="font-bold text-lg text-gray-900">BDE-Events</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    ...
                    <li><a href="/events" class="hover:text-blue-600 transition-all duration-300">Upcoming Events</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    <li><a href="#" class="hover:text-blue-600 transition-all duration-300">BDE Office</a></li>
                    <li><a href="#" class="hover:text-blue-600 transition-all duration-300">Contact Us</a></li>
