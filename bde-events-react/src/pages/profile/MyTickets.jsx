...
function MyTickets() {
   ...
   useEffect(() => {
    api.get("/user/tickets")
        .then((response) => {
            console.log("MY TICKETS =", response.data.data);
            ...
            <main className="py-12">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Ticket */}
                       ...
                       {tickets.map((t) => (
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" key={t.id}>
                            <div
                                key={t.id}
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-medium text-blue-600">
                                                {t.reservation.event.date}
                                            </p>

                                            <h2 className="mt-2 text-2xl font-bold text-gray-900">
                                                {t.reservation.event.title}
                                            </h2>
